			...
			<div id="build">
				...
				<div className="imageBoxer">
					...
					<div>
						...
						<Image alt="build" src={build.src} className="smImg leftImg" />
				...
				<div className="imageBoxer" >
					<div>
						...
						<Image alt="rocket" src={rocket.src} className="smImg rightImg" />
					...
					<div className="flexImg"> 
						<Image alt="rocket" src={rocket.src}  />
					</div>
				</div>
				<div>
