...
const Services: FC = () => (<>
		...
		<SlidingSection image={{src: letsGo.src, alt: 'let\'s go!'}}className={style.interested}><h4>Interested? Good. Let&apos;s get  you on the path to your company&apos;s best future, today.</h4> their 
		<Links />
		</SlidingSection></>)
